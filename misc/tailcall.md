...
## msbuild cl.exe x86 opt level /Od
```
$ cl /EHsc /c /Od main.cpp
...
## msbuild cl.exe x86 opt level /O2
```
...
## msbuild cl.exe x86_64 opt level /Od
```
$ cl /EHsc /c /Od main.cpp
$ dumpbin /DISASM main.obj
```
...
## msbuild cl.exe x86_64 opt level /O2
```
$ cl /EHsc /c /O2 main.cpp
$ dumpbin /DISASM main.obj
```
