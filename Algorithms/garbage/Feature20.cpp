...
/*
 *	P0614R1
 *http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0614r1.html Test done
 ...
 *	Test failed: declared support in clang 9, but not implemented (?); need
 *fix (?) clang -std=c++2a -c filename
 */
//#define P1301R4
#ifdef P1301R4
#include <cstddef>

[[nodiscard("reason")]] std::size_t *Check(void) { return new std::size_t; };
...
/*
 *	P1002R1
 *http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p1002r1.pdf Test done
 *	clang -std=c++2a -c filename
 */
//#define P1002R1
#ifdef P1002R1
...
/*
 *	P1009R2
 *http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1009r2.pdf Test done
 *	clang -std=c++2a -c filename
 */
//#define P1009R2
#ifdef P1009R2
